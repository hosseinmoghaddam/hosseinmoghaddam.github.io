    ...
    jQuery(window).load(function () {
        ...
        console.log(social);
           for(var i=0; i<social.length; i++) {
               social[i].style.marginLeft = "12px";
//                console.log(social[1].style.marginLeft);
    }
//         social.style.marginLeft = -12;
}


        sr.reveal(commonCards, {duration: 1100});
        sr.reveal('#about-card,.map-label', {duration: 1400, delay: 500});
        sr.reveal('#v-card-holder', {duration: 1400, distance: '150px', afterReveal: myCallback});
        sr.reveal('.links', {duration: 1400, distance: '150px'})
